...
function customize_buildroot() {
        ...
        $mkdir -p "$portage/patches/x11-drivers/nvidia-drivers-440.82"
        $curl -L 'https://726688.bugs.gentoo.org/attachment.cgi?id=643102' > "$portage/patches/x11-drivers/nvidia-drivers-440.82/linux-5.7.patch"
        test x$($sha256sum "$portage/patches/x11-drivers/nvidia-drivers-440.82/linux-5.7.patch" | sed -n '1s/ .*//p') = x2d2996aa4475e006d8cc1ae7c1884b6d42505304c0bccf7631982ffe080ee41a
